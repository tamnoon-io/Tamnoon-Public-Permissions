```json    
{
  "Name": "Tamnoon Remediation Role for Wiz Alerts",
  "Id": null,
  "IsCustom": true,
  "Description": "Tamnoon Custom role for Wiz security alert remediation across Azure Services",
  "Actions": [
  ...
  "NotDataActions": [],
  "AssignableScopes": [
    "/providers/Microsoft.Management/managementGroups/{tenant-root-group-id}",
